...
<script language="javascript" type="text/javascript" src="<%=basePath %>usersell/js/My97DatePicker/WdatePicker.js">
...
<body>
    ...
    <form action="${path}/productServlet?method=useraddProduct&uid=${uid}" method="post" enctype="multipart/form-data">
	    <ul class="forminfo">
	    	 <!-- 商品分类信息 -->
	    	 <li>
	    	 	<label>商品分类</label>
		    ...
		    <li><label>&nbsp;</label><input type="submit" class="btn" value="确认上传" οnclick="window.close()"/></li>
	    </ul>
    </form>
    </div>
</body>
